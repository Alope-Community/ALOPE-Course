...
export default function ArticleIndexPage() {
    return (
        <>
            ...
            <main className="container mx-auto grid grid-cols-4 gap-10 pt-24">
                <section className="col-span-3">
                    <header>
                        ...
                        <div className="-mt-1 rounded-b border border-t-0 border-[#2276f0] p-5">
                            ...
                            <h3 className="mb-7 mt-6 text-xl font-bold">
                    ...
                    <div className="relative mb-10 mt-20 flex items-center justify-center gap-10 rounded bg-gradient-to-r from-[#5b8df3] to-[#307de9] p-10 text-gray-100">
                        <img
                ...
                <aside>
                    <h3 className="mb-7 mt-4 text-xl font-bold">
                    ...
                    <div className="mb-5 pl-4">
                        ...
                        <p className="relative mt-1 flex font-medium before:absolute before:-left-3.5 before:top-2 before:size-2 before:rounded-full before:bg-[#2276f0] before:content-['']">
